...
document.addEventListener('DOMContentLoaded', () => {
  // marca contenedores que tienen overflow real
  document.querySelectorAll('.table-responsive').forEach(w => {
    if (w.scrollWidth > w.clientWidth) w.classList.add('scrollable');
  });

  // drag-to-scroll (táctil y mouse)
  document.querySelectorAll('.table-responsive').forEach(scroller => {
